...
const properties: INodeProperties[] = [
	{
		displayName:
			'Documentation: <a href="https://www.bitdefender.com/business/support/en/77209-1223776-getinstalledpatches.html" target="_blank" rel="noopener noreferrer">Get Installed Patches</a>',
		name: 'getInstalledPatchesDocsNotice',
		type: 'notice',
		default: '',
	},
	companyTypeProperty,
	{
		...
		default: '',
		description:
			'A comma-separated list of endpoint IDs to retrieve installed patches for (e.g. "1234567890, 1234567891, 1234567892")',
	},
	{
		displayName: 'Options',
		name: 'options',
...
const displayOptions = {
	show: { category: ['patch_management'], action: ['getInstalledPatches'] },
};
